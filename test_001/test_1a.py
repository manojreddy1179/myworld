...
cl.click()
time.sleep(15)
g = driver.find_element_by_xpath("/html[1]/body[1]/div[1]/aside[1]/section[1]/ul[1]/li[2]/a[1]/span[1]")
g.click()
time.sleep(5)
h = driver.find_element_by_xpath("/html[1]/body[1]/div[1]/aside[1]/section[1]/ul[1]/li[2]/ul[1]/li[2]/a[1]")
h.click()
time.sleep(10)
